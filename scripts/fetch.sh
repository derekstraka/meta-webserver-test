...
METAWEBSERVERTEST_URI="."
METAWEBSERVERTEST_PATH="poky/meta-webserver-test"
...
rm -rf "${METAWEBSERVERTEST_PATH}" || die "unable to clear old ${METAWEBSERVERTEST_PATH}"
ln -sf "../${METAWEBSERVERTEST_URI}" "${METAWEBSERVERTEST_PATH}" || \
	die "unable to symlink ${METAWEBSERVERTEST_PATH}"
